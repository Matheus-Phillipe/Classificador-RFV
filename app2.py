...
def main():
   ...
   if data_file_1 is not None:
       ...
       st.write('Quantos dias faz que o cliente realizou sua última compra?')
       ...
       st.write("Um jeito de segmentar os clientes é criando quartis para cada componente do RFV, sendo que o melhor quartil é chamado de 'A', o segundo melhor quartil de 'B', o terceiro melhor de 'C' e o pior de 'D'. O melhor e o pior depende da componente. Por exemplo, quanto menor a recência, melhor é o cliente (pois ele comprou com a gente há pouco tempo), logo o menor quartil seria classificado como 'A', já para a componente frequência a lógica se inverte, ou seja, quanto maior a frequência do cliente em comprar com a gente, melhor ele/a é, logo, o maior quartil recebe a letra 'A'.")
       st.write('Se a gente tiver interessado em mais ou menos classes, basta aumentar ou diminuir o número de quantis para cada componente.')
       ...
       st.write('Melhores clientes em relação aos 3 fatores. Menor recência, maior frequência e maior valor.')
       ...
       st.download_button(label='📥 Download em EXCEL',
                          data=df_xlsx,
                          file_name='RFV_.xlsx')
